...
import com.awoisoak.market.presentation.main.clothesfragment.dagger.ClothesModule;
...
/**
 * All category products Fragment.
 */
public class ClothesFragment extends Fragment implements ClothesView,
        ClothesAdapter.ProductItemClickListener {

    private static final String TAG = ClothesFragment.class.getSimpleName();
    @BindView(R.id.clothes_progress_bar)
    ProgressBar mProgressBar;
    @BindView(R.id.clothes_text_view)
    TextView mLoadingText;
    @BindView(R.id.clothes_recycler)
     ...
     */
    public static ClothesFragment newInstance(int sectionNumber) {
    ...
    private void initDagger() {
        DaggerClothesComponent.builder()
                .clothesModule(new ClothesModule(this))
                .marketApiComponent(
    ...
    public void bindProductsList(List<Product> products) {
        mAdapter = new ClothesAdapter(products, this, getActivity());
