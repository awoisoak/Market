...
public class VideogamesAdapter extends
        RecyclerView.Adapter<VideogamesAdapter.ProductViewHolder> {

    public static final String TAG = VideogamesAdapter.class.getSimpleName();
    ...
    public VideogamesAdapter(List<Product> products, ProductItemClickListener listener,
            Context context) {
        mProducts = products;
        mListener = listener;
        mContext = context;
    ...
    public ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View rootView = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.item_videogames_list, parent, false);
    ...
    public class ProductViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        @BindView(R.id.item_videogames_image) ImageView ivItem;
        @BindView(R.id.item_videogames_sold_out) ImageView ivSoldOut;
        @BindView(R.id.item_videogames_name) TextView name;
        @BindView(R.id.item_videogames_likes_button) ImageView likesButton;
        @BindView(R.id.item_videogames_comments_button) ImageView commentsButton;
        @BindView(R.id.item_videogames_comments_numbers) TextView numComments;
        @BindView(R.id.item_videogames_likes_numbers) TextView numLikes;
        @BindView(R.id.item_videogames_price) TextView price;
